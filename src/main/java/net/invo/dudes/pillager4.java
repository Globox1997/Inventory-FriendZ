...
public class pillager4 extends Item {
    public int count = 0;
    public int count2 = 0;

    public pillager4(Settings settings) {
        super(settings);
    ...
    public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
        tooltip.add(new TranslatableText("item.invo.pillager4.tooltip"));
        if (!configinit.CONFIG.conduitingpillager) {
    ...
    public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
        StatusEffectInstance conduit = new StatusEffectInstance(StatusEffect.byRawId(29), 0, 0, false, false);
