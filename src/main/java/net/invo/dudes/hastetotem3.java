...
public class hastetotem3 extends Item {
  public int count = 0;
  public int count2 = 0;

  public hastetotem3(Settings settings) {
    super(settings);
  ...
  public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
    tooltip.add(new TranslatableText("item.invo.hastetotem3.tooltip"));
    tooltip.add(new TranslatableText("item.invo.hastetotem3.tooltip2"));
