...
public class nightvisiontotem3 extends Item {
  public static int count = 0;
  public static int count2 = 0;

  public nightvisiontotem3(Settings settings) {
    super(settings);
  ...
  public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
    tooltip.add(new TranslatableText("item.invo.nightvisiontotem3.tooltip"));
  }

  public void inventoryTick(ItemStack stack, World world, Entity entity, int slot, boolean selected) {
    StatusEffectInstance night = new StatusEffectInstance(StatusEffect.byRawId(16), 0, 0, false, false);
