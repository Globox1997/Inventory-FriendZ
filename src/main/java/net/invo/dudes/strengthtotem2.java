...
public class strengthtotem2 extends Item {
  public static int count = 0;
  public static int count2 = 0;

  public strengthtotem2(Settings settings) {
    super(settings);
  ...
  public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
    tooltip.add(new TranslatableText("item.invo.strengthtotem2.tooltip"));
    tooltip.add(new TranslatableText("item.invo.strengthtotem2.tooltip2"));
  }
