...
public class hastetotem2 extends Item {
  public int count = 0;
  public int count2 = 0;

  public hastetotem2(Settings settings) {
    super(settings);
  ...
  public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
    tooltip.add(new TranslatableText("item.invo.hastetotem2.tooltip"));
    tooltip.add(new TranslatableText("item.invo.hastetotem2.tooltip2"));
    if (!configinit.CONFIG.hastetotem) {
