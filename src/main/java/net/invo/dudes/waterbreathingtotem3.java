...
public class waterbreathingtotem3 extends Item {
  public int count = 0;
  public int count2 = 0;

  public waterbreathingtotem3(Settings settings) {
    super(settings);
  ...
  public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
    tooltip.add(new TranslatableText("item.invo.waterbreathingtotem3.tooltip"));
    tooltip.add(new TranslatableText("item.invo.waterbreathingtotem3.tooltip2"));
