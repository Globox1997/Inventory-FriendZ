...
public class fireresistancetotem2 extends Item {
  public int count = 0;
  public int count2 = 0;

  public fireresistancetotem2(Settings settings) {
    super(settings);
  ...
  public void appendTooltip(ItemStack itemStack, World world, List<Text> tooltip, TooltipContext tooltipContext) {
    tooltip.add(new TranslatableText("item.invo.fireresistancetotem2.tooltip"));
    tooltip.add(new TranslatableText("item.invo.fireresistancetotem2.tooltip2"));
    if (!configinit.CONFIG.fireresistancetotem) {
