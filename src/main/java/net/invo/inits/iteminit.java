...
public class iteminit {
        ...
        public static final nightvisiontotem1 NIGHTVISIONTOTEM1 = new nightvisiontotem1(
                        new Item.Settings().maxCount(1));
        public static final nightvisiontotem2 NIGHTVISIONTOTEM2 = new nightvisiontotem2(
                        new Item.Settings().maxCount(1));
        public static final nightvisiontotem3 NIGHTVISIONTOTEM3 = new nightvisiontotem3(
                        new Item.Settings().maxCount(1));
        ...
        public static final optotem OPTOTEM = new optotem(new Item.Settings().maxCount(1).fireproof());
